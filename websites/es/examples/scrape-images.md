...
::: tip SEO
El texto `alt` (con las [palabras clave del contenido](/examples/extract-keywords)) es utilizado por los motores de búsqueda para las búsquedas basadas en imágenes. Asegúrese de definirlo siempre.
:::
